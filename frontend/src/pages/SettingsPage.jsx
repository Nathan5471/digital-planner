            ...
            <div className="flex flex-col bg-gray-100 items-center justify-center min-h-screen">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md w-96">
                    ...
                    <div className="mt-4 flex flex-row justify-between items-center">
                        ...
                        <button className="bg-blue-500 text-white text-lg p-2 rounded transform transition duration-200 ease-in-out hover:scale-105 hover:bg-blue-600 focus:outline-none">Edit</button>
                    </div>
                    <div className="mt-4 flex flex-row justify-between items-center">
